...
INSERT INTO CS_APPOINTMENT (A_START, A_I_ID, A_C_ID)
    VALUES ('2022-12-14 00:00:00', 1, 1);

-- id = 2
INSERT INTO CS_APPOINTMENT (A_START, A_I_ID, A_C_ID)
    VALUES ('2022-12-21 00:00:00', 1, 1);

-- id = 3
INSERT INTO CS_APPOINTMENT (A_START, A_I_ID, A_C_ID)
    VALUES ('2023-01-11 00:00:00', 2, 1);

-- id = 4
INSERT INTO CS_APPOINTMENT (A_START, A_I_ID, A_C_ID)
    VALUES ('2023-01-18 00:00:00', 9, 1);

-- id = 5
INSERT INTO CS_APPOINTMENT (A_START, A_I_ID, A_C_ID)
    VALUES ('2023-01-25 00:00:00', 3, 1);

-- id = 6
INSERT INTO CS_APPOINTMENT (A_START, A_I_ID, A_C_ID)
    VALUES ('2023-02-01 00:00:00', 8, 1);

-- id = 7
INSERT INTO CS_APPOINTMENT (A_START, A_I_ID, A_C_ID)
    VALUES ('2023-01-01 00:00:00', 4, 1);

-- id = 8
INSERT INTO CS_APPOINTMENT (A_START, A_I_ID, A_C_ID)
    VALUES ('2023-02-22 00:00:00', 7, 2);

-- id = 9
INSERT INTO CS_APPOINTMENT (A_START, A_I_ID, A_C_ID)
    VALUES ('2023-04-07 00:00:00', 5, 3);

-- id = 10
INSERT INTO CS_APPOINTMENT (A_START, A_I_ID, A_C_ID)
    VALUES ('2023-04-14 00:00:00', 6, 3);

-- id = 11
INSERT INTO CS_APPOINTMENT (A_START, A_I_ID, A_C_ID)
    VALUES ('2023-05-09 00:00:00', 3, 4);

-- id = 12
INSERT INTO CS_APPOINTMENT (A_START, A_I_ID, A_C_ID)
    VALUES ('2023-05-16 00:00:00', 3, 4);

-- id = 13
INSERT INTO CS_APPOINTMENT (A_START, A_I_ID, A_C_ID)
    VALUES ('2023-05-23 00:00:00', 6, 4);

-- id = 14
INSERT INTO CS_APPOINTMENT (A_START, A_I_ID, A_C_ID)
    VALUES ('2023-05-30 00:00:00', 4, 4);
